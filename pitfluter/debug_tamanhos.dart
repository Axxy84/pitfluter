...
void main() async {
  ...
  try {
    ...
    for (final tamanho in tamanhos) {
      print('DEBUG: ID: ${tamanho['id']}, Nome: "${tamanho['nome']}"');
    }
    ...
    for (final preco in precos) {
      print('DEBUG: Tamanho ID: ${preco['tamanho_id']}, Preço: ${preco['preco']}');
    }
    ...
    for (final preco in precosPizza) {
      ...
      print('DEBUG: Tamanho: ${tamanhoInfo['nome']}, Preço: ${preco['preco']}');
    }
    ...
    if (precosPizza.isNotEmpty) {
      ...
      print('DEBUG: tamanho_id type: ${primeiroPreco['tamanho_id'].runtimeType}');
      print('DEBUG: tamanho_id value: ${primeiroPreco['tamanho_id']}');
    }
    
    if (tamanhos.isNotEmpty) {
      final primeiroTamanho = tamanhos.first;
      print('DEBUG: tamanho.id type: ${primeiroTamanho['id'].runtimeType}');
      print('DEBUG: tamanho.id value: ${primeiroTamanho['id']}');
    }
